...
public class DoubleSolenoidChannels {
  ...
  /**
   * @param forwardChannel The channel number foe the forward channel of the double solenoid
   * @param reverseChannel The channel number foe the forward channel of the double solenoid
   */
